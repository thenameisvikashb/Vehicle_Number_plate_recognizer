...
<?php
    ...
    if(isset($_REQUEST["btnsave"])){
        $rule=$_REQUEST['txtrule'];
        $fee=$_REQUEST['txtfee'];
        $qry_n="INSERT INTO reason
                    (reason,fee)
                    values
                    ('".$rule."','".$fee."');
                ";
        ...
        if($result_n){
           ?>
            <script type="text/javascript">
                alert("Data Inserted");
                window.location.href="traffic_rule.php";
            </script>
               <?php
       }else{
           ?>
                ...
                <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Traffic Rules and Fee</h4>
                                    <p class="card-category">Here is the complite information</p>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card strpied-tabled-with-hover">
                                <div class="card-header ">
                                    <h4 class="card-title">Add new rule and fee</h4>
                                </div>
                                <div class="card-body table-full-width table-responsive">
                                    <div class="card-body">
                                    <form>
                                        <div class="row">
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    <label>Rule</label>
                                                    <input type="text" class="form-control" placeholder="" value="" name="txtrule">
                                                </div>
                                            </div>
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    <label>Fee</label>
                                                    <input type="text" class="form-control" placeholder="" value="" name="txtfee">
                                                </div>
                                            </div>
                                        </div>
                                        <center><button type="submit" class="btn btn-info btn-fill" name="btnsave">Save</button></center>
